...
function filterProducts() {
    ...
    // Category checkboxes
    const catChecks = ['موبايلات', 'لابتوبات', 'ساعات ذكية', 'سماعات', 'كاميرات', 'ألعاب'];
...
function renderProducts(products) {
    ...
    grid.innerHTML = products.map(p => `
        <div class="product-card" onclick="window.location.href='productDetails.html?id=${p.id}'">
            ${p.badge ? `<span class="product-badge badge-${p.badge}">${p.badge === 'new' ? 'جديد' : p.badge === 'sale' ? 'خصم' : '🔥 رائج'}</span>` : ''}
       ...
       onerror="this.style.display='none'">
            ...
            <div class="product-info">
                ...
                <div class="product-price">
                    <span class="price-current">${p.price.toLocaleString()} ج.م</span>
